...
uploaded_file = st.sidebar.file_uploader("Choose a File to Analyze (24 Hours Format)")
    ...
    # emoji analysis
        ...
        with col2:
            try:
                ...
                print("error in col2 emojies section")


st.sidebar.write('Created By Mohd Ujaid')